...
void SoundItem::Update(float dt)
{

}

void SoundItem::Render()
{
...
bool SoundItem::SetSource(ALfloat pos[3], ALfloat vel[3], bool Looping)
{
...
void SoundItem::loadWav(std::string filePath)
{
